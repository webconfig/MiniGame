...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Google_Protobuf_ByteString_Binding
    {
        ...
        static StackObject* get_Length_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Google.Protobuf.ByteString instance_of_this_method;
            instance_of_this_method = (Google.Protobuf.ByteString)typeof(Google.Protobuf.ByteString).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
