...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Animator_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, SetBool_0);


        }


        static StackObject* SetBool_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
