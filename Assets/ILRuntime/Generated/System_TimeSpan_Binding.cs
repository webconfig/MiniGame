...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_TimeSpan_Binding
    {
        ...
        static StackObject* get_TotalMilliseconds_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            System.TimeSpan instance_of_this_method;
            instance_of_this_method = (System.TimeSpan)typeof(System.TimeSpan).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
