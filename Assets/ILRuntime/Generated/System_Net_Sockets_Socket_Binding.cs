...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Net_Sockets_Socket_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, SetSocketOption_0);
            ...
            app.RegisterCLRMethodRedirection(method, ReceiveFrom_1);
            args = new Type[]{};
            ...
            app.RegisterCLRMethodRedirection(method, SendTo_3);
            ...
            app.RegisterCLRMethodRedirection(method, BeginConnect_5);
            args = new Type[]{typeof(System.IAsyncResult)};
            method = type.GetMethod("EndConnect", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, EndConnect_6);
            args = new Type[]{typeof(System.Byte[])};
            method = type.GetMethod("Receive", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Receive_7);
        ...
        static StackObject* ReceiveFrom_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
                ...
                case ObjectTypes.FieldReference:
                    {
                        ...
                        else
                        {
                            ...
                            t.SetFieldValue(ptr_of_this_method->ValueLow, ref ___obj, remoteEP);
                        }
                    }
                    break;
                case ObjectTypes.StaticFieldReference:
                    {
                        ...
                        if(t is ILType)
                        {
                            ((ILType)t).StaticInstance[ptr_of_this_method->ValueLow] = remoteEP;
                        }
                        else
                        {
                            ((CLRType)t).SetStaticFieldValue(ptr_of_this_method->ValueLow, remoteEP);
                        }
                    }
                    break;
        ...
        static StackObject* SendTo_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 6);
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Net.EndPoint remote_end = (System.Net.EndPoint)typeof(System.Net.EndPoint).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            System.Net.Sockets.SocketFlags flags = (System.Net.Sockets.SocketFlags)typeof(System.Net.Sockets.SocketFlags).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
            ptr_of_this_method = ILIntepreter.Minus(__esp, 3);
            ...
            var result_of_this_method = instance_of_this_method.SendTo(buffer, offset, size, flags, remote_end);
        ...
        static StackObject* BeginConnect_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            ...
            var result_of_this_method = instance_of_this_method.BeginConnect(host, port, callback, state);
        ...
        static StackObject* EndConnect_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.IAsyncResult result = (System.IAsyncResult)typeof(System.IAsyncResult).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            System.Net.Sockets.Socket instance_of_this_method;
            instance_of_this_method = (System.Net.Sockets.Socket)typeof(System.Net.Sockets.Socket).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            ...
            instance_of_this_method.EndConnect(result);

            return __ret;
        }

        static StackObject* Receive_7(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* EndSend_9(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            var result_of_this_method = instance_of_this_method.EndSend(result);
