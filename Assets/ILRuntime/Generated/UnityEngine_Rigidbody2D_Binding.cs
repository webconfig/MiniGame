...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Rigidbody2D_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, set_simulated_0);


        }


        static StackObject* set_simulated_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
