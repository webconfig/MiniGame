...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_UI_Image_Binding
    {
        ...
        static StackObject* set_sprite_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.UI.Image instance_of_this_method;
            instance_of_this_method = (UnityEngine.UI.Image)typeof(UnityEngine.UI.Image).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
